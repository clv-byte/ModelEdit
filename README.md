...
|[Editing Factual Knowledge in Language Models](https://arxiv.org/abs/2104.08164)|EMNLP 2021|[code](https://github.com/nicola-decao/KnowledgeEditor)|Nicola De Cao|将模型知识编辑看作一种学习任务，微调模型参数，只是在损失函数里加入了更新前后原有知识KL散度限制||
